  ...
  (setq-default
   ...
   '(
     ...
     (org :variables
          ...
          org-reveal-root "file://~/.spacemacs.d/reveal.js")
     markdown
     ;; spell-checking
     syntax-checking
...
(defun dotspacemacs/user-config ()
  ...
  (add-to-list 'load-path "~/self/slime")
